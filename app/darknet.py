...
if os.name == "nt":
    ...
    DARKNET_PATH='/ap/flask/app'
    #print(os.path.join(os.environ.get('DARKNET_PATH', DARKNET_PATH),"libdarknet.so"))
    lib = CDLL(os.path.join(os.environ.get('DARKNET_PATH',DARKNET_PATH),
